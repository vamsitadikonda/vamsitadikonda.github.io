/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-23c112ca2560a409e96b.js.LICENSE.txt */
  ...
  [0],
  {
    ...
    '20nU': function (e, t) {
      e.exports = {
        ...
        socialMedia: [
          { name: 'GitHub', url: 'https://github.com/vamsitadikonda' },
          { name: 'Linkedin', url: 'https://www.linkedin.com/in/vamsitadikonda/' },
          { name: 'Codepen', url: 'https://codepen.io/chandrikadeb7' },
          { name: 'Instagram', url: 'https://www.instagram.com/vamsitadikonda/' },
          { name: 'Twitter', url: 'https://twitter.com/vamsitadikonda' },
        ],
        navLinks: [
        ...
        return (
          ...
          (n.render = function () {
            ...
            var R = !1 === this.state.fadeIn || this.state.imgLoaded,
              ...
              F = this.state.isHydrated ? h(S) : S[0];
            if (A)
              return l.default.createElement(
                v,
                {
                ...
                this.addNoScript &&
                  l.default.createElement('noscript', {
                    dangerouslySetInnerHTML: {
                      __html: O(
                        (0, s.default)({ alt: n, title: t, loading: w }, F, { imageVariants: S }),
                      ),
                    },
                  }),
              );
    ...
    Kvkj: function (e, t, n) {
        ...
        function p(e) {
          for (var t = 0, n = s.animations, r = n.length; t < r; ) {
            ...
            for (
              ...
              (y = l.isPath ? Fe(l.value, d * v, l.isPathTargetInsideSVG) : b + d * (v - b)),
      ...
      var tt,
        ...
        Ha = Object(Y.c)(P.c).withConfig({
          ...
          Fa.md,
          Da.SFMono,
          P.f.desktop(on || (on = Object(gn.a)(['font-size: ', ';'])), Fa.sm),
          Fa.sm,
          P.f.desktop(cn || (cn = Object(gn.a)(['font-size: ', ';'])), Fa.smish),
        ),
    ...
    nLfd: function (e, t, n) {
      ...
      function V(e, t) {
        ...
        var n = this.store.sequences[e.sequence.id],
          r = e.sequence.index;
        if (n) {
          var a = new F(n, 'visible', this.store),
            o = new F(n, 'revealed', this.store);
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-23c112ca2560a409e96b.js.map
